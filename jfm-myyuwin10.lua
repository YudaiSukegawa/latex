...
local t = {
   ...
   [0] = {
      ...
      glue = {
	 [1] = { 0.25 , 0.0, 0.25, ratio=1, kanjiskip_stretch=1 },
...
-- 3 は四分, 2, 4, 9 は0, あとは0.5
	 [0] = { 0.25 , 0.0, 0.25, ratio=0, kanjiskip_stretch=1 },
   ...
   [102] = { -- 区切り
      chars = {'：'},
      align = 'middle', left = 0.11, down = 0.17,
      width = 0.5, height = 0.88, depth = 0.12, italic=0.0,
      --end_stretch = 0.25,
      glue = {
-- 3 は四分, 2, 4, 9 は0, あとは0.5
   ...
   [202] = { -- 区切り
      chars = {'；'},
      align = 'middle', left = 0.11, down = 0.12,
      width = 0.5, height = 0.88, depth = 0.12, italic=0.0,
      --end_stretch = 0.25,
      glue = {
-- 3 は四分, 2, 4, 9 は0, あとは0.5
